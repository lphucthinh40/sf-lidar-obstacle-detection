...
public:
    ...
    void KDTreeClustering(int idx, typename pcl::PointCloud<PointT>::Ptr cloud, KdTree<PointT>* tree, float distanceTol, std::vector<int> &cluster, std::vector<bool> &processed);
